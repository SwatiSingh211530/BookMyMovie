...
import React, { useEffect, useCallback } from "react"; // React hooks for creating functional components and managing state
...
function ProtectedRoute({ children }) {
  ...
  }, [getCurrentUser, navigate]); // Include dependencies
